      ...
      <section id="contact" style={{ backgroundColor: "#fff" }}>
        <div className="welco">
          ...
          <p style={{ textAlign: "center" }}>
            interested in hiring me ? You can fill in the contact form below or
            send me an email to
            <a style={{ color: "brown" }} type="email">
              {" "}
              msellekmoaad@gmail.com
            </a>
            <br />
            <svg
            ...
            Morocco, Rabat <br /> <br />
            You can also find me on the following channels : <br />
            <div className="soci">
              <Link
                onClick={() =>
                  window.open(
              ...
              <Link
                onClick={() =>
                  window.open("https://www.hackerrank.com/moadlzrak", "_blank")
                }
              >
        ...
        <div className="container pb-5">
          <h2 className="h1-responsive gh font-weight-bold text-center mb-4">
            Get In Touch
          </h2>
          <div className="form">
            <div className="row">
